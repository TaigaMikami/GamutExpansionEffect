...
for m = 0:1:30
    ...
    filename = sprintf('flower-target_bulr%d.bmp',m*5);
    Org = imread(strcat('newExpImage/match/flower/bulr/',filename));
    Output = strcat('sokedImage/match/flower/bulr/',filename);
