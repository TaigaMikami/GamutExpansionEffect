...
for m = 0:1:30
    ...
    filename = sprintf('flower-target_rand%d.bmp',m*5);
    Org = imread(strcat('orgImage/flower/random/rand5/match/',filename));
    Output = strcat('image/flower/random_img/match/rand5/',filename);
